...
namespace Persistence.Migrations
{
    ...
    [Migration("20230721113952_InitialCreate2")]
            ...
            modelBuilder.Entity("Domain.Entities.Attendence", b =>
                {
                    ...
                    b.Property<DateTime?>("DayDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 7, 21, 14, 39, 52, 676, DateTimeKind.Local).AddTicks(9924));
            ...
            modelBuilder.Entity("Domain.Entities.BannedCustomer", b =>
                {
                    ...
                    b.Property<DateTime?>("BanDate")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 7, 21, 14, 39, 52, 677, DateTimeKind.Local).AddTicks(2715));
            ...
            modelBuilder.Entity("Domain.Entities.Borrow", b =>
                {
                    ...
                    b.Property<DateTime>("BorrowDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 7, 21, 14, 39, 52, 677, DateTimeKind.Local).AddTicks(5829));
                    ...
                    b.Property<DateTime>("ReturnDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 7, 24, 14, 39, 52, 677, DateTimeKind.Local).AddTicks(6110));
            ...
            modelBuilder.Entity("Domain.Entities.Order", b =>
                {
                    ...
                    b.Property<DateTime>("OrderDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 7, 21, 14, 39, 52, 677, DateTimeKind.Local).AddTicks(7898));
            ...
            modelBuilder.Entity("Domain.Entities.Payroll", b =>
                {
                    ...
                    b.Property<DateTime?>("SalaryDate")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 7, 21, 14, 39, 52, 678, DateTimeKind.Local).AddTicks(685));
            ...
            modelBuilder.Entity("Domain.Entities.ReturnedOrder", b =>
                {
                    ...
                    b.Property<DateTime>("ReturnDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 7, 21, 14, 39, 52, 678, DateTimeKind.Local).AddTicks(1488));
